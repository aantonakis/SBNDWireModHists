...
def run_grid(inputfiles):
    ...
    os.system('cp ../grid/bin/grid_executable_multi_dim_tracks_gen2.sh %s' %MasterJobDir)
    ...
    cp_script = "cp " + WIREMOD_WORKING_DIR + "/macros/multi_dim_tracks_gen2_grid.C " + MasterJobDir
...
"file://$(pwd)/grid_executable_multi_dim_tracks_gen2.sh" \\
"%s" \\
"%s" \\
