...
def run_grid(inputfiles):
    ...
    os.system('cp ../grid/bin/grid_executable_caf_multi_dim_tracks.sh %s' %MasterJobDir)
    ...
    cp_script = "cp " + WIREMOD_WORKING_DIR + "/macros/caf_multi_dim_tracks_grid.C " + MasterJobDir
...
"file://$(pwd)/grid_executable_caf_multi_dim_tracks.sh" \\
"%s" \\
"%s" \\
