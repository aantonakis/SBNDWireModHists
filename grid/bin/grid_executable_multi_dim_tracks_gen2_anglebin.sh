...
cp -r ${filesFromSender}/multi_dim_tracks_gen2_anglebin_grid.C .
...
root -l -b -q "multi_dim_tracks_gen2_anglebin_grid.C(\"input_list_${nProcess}.txt\", \"${nProcess}\", \"${config}\")" &> log_${nProcess}.log
